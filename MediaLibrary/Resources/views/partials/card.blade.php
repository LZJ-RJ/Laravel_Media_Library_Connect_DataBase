<v-touch class="card"
    ...
    <div class="card-image">
        ...
        <object v-if="selectedFileIs('pdf') || selectedFileIs('text')"
            ...
            <p v-if="selectedFileIs('pdf')">{{ trans('medialibrary::messages.pdf') }}</p>
        </object>
    ...
    <div class="card-content">
        ...
        <p class="title is-marginless">
            ...
            <a :href="selectedFile.path"
                ...
                rel="noreferrer noopener"
                target="_blank"
                title="{{ trans('medialibrary::messages.public_url') }}"
                v-tippy="{arrow: true}">
            ...
            <div class="level-left">
                ...
                <div class="level-item">
                    <span v-if="$refs.lock"
                        ...
                        :title="IsLocked(selectedFile) ? '{{ trans('medialibrary::messages.unlock') }}' : '{{ trans('medialibrary::messages.lock') }}'"
                ...
                <div class="level-item">
                    <span v-if="$refs.visibility"
                        ...
                        title="{{ trans('medialibrary::messages.visibility.set') }}"
                        v-tippy="{arrow: true}"
            ...
            <div class="level-right">
                ...
                <div class="level-item">
                    <span class="icon is-large link is-black"
                        title="{{ trans('medialibrary::messages.download.file') }}"
                        v-tippy="{arrow: true}"
