...
<template v-if="bulkItemsFilter.length">
        ...
        <div class="media" v-for="one in bulkItemsFilter" :key="one.path">
            ...
            <div class="media-content">
                <p class="title is-4">
                    ...
                    <small v-if="one.items" class="has-text-link">"@{{ one.items }} {{ trans('medialibrary::messages.items') }}"</small>
                </p>
        ...
        <div class="media">
            ...
            <div class="media-content">
                <p class="title is-4">
                    ...
                    <small class="has-text-link">{{ trans('medialibrary::messages.too_many_files') }}</small>
                </p>
            </div>
        </div>
    </template>
    ...
    <p v-if="bulkItemsFilterSize" class="__modal-delete-total">
        ...
        <span class="heading">{{ trans('medialibrary::messages.total') }}</span>
    </p>
</template>
            ...
            <div class="media-content">
                <p class="title is-4">
                    ...
                    <small v-if="selectedFile.items" class="has-text-link">
                        "@{{ selectedFile.items }} {{ trans('medialibrary::messages.items') }}"
                    </small>
                </p>
