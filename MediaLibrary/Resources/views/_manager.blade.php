            ...
            <section class="__stack-container">
                ...
                <div>
                    ...
                    <div id="loading_files" v-show="loading_files">
                        <div id="loading_files_anim" data-json="{{ asset('assets/vendor/mediaLibrary/lottie/world.json') }}"></div>
...
{{-- styles --}}
@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/mediaLibrary/style.css') }}"/>
@endpush
